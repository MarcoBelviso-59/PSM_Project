...
- **Figure (PNG):** cartella `figures/`
  ...
  - `figures/mean_by_category_bars_fixed.png`
...
- **PSM risulta più severo della baseline** (Δ medio negativo): nel confronto diretto, molti casi ricevono punteggi inferiori rispetto a zxcvbn.
